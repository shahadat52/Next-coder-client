...
const FAQ = () => {
  return (
    <div>
      <section className="dark:bg-gray-800 text-blue-500">
        <div className="container flex flex-col items-center p-4 mx-auto md:p-8">
          ...
          <div className="relative mt-6 mb-12">
            ...
            <input
              ...
              name="Search"
              placeholder="Search..."
              className="w-full py-3 pl-12 text-sm rounded-full text-blue-400 sm:w-96 bg-gray-300 focus:outline-none dark:bg-gray-800 dark:text-blue-400 focus:dark:bg-gray-900"
            />
          </div>
